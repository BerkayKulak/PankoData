...
class SıcaklıkHarcananSuGrafigiBar(QtWidgets.QMainWindow):

    def __init__(self, *args, **kwargs):
        super(SıcaklıkHarcananSuGrafigiBar, self).__init__(*args, **kwargs)
        ...
        ax2.bar(dataframe2.index, dataframe2["mililitre"], color="red")
...
def ass():
    ...
    ass = SıcaklıkHarcananSuGrafigiBar()
    ass.show()
    sys.exit(app.exec_())
